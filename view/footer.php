            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="tf-element-carousel section" data-slick-options='{
                        ...
                        <div class="brand col"><a href="#"><img src="/Project_demo/uploads/images/brands/brand-1.png" alt=""></a>
                        </div>
                        <div class="brand col"><a href="#"><img src="/Project_demo/uploads/images/brands/brand-2.png" alt=""></a>
                        </div>
                        <div class="brand col"><a href="#"><img src="/Project_demo/uploads/images/brands/brand-3.png" alt=""></a>
                        </div>
                        <div class="brand col"><a href="#"><img src="/Project_demo/uploads/images/brands/brand-4.png" alt=""></a>
                        </div>
                        <div class="brand col"><a href="#"><img src="/Project_demo/uploads/images/brands/brand-5.png" alt=""></a>
                        </div>
                    </div>
                    <!--Brand Slider end-->
                </div>
                    ...
                    <div class="row row-25">
                        ...
                        <div class="footer-widget col-lg-3 col-md-6 col-sm-6 col-12 mb-40 mb-xs-35">
                            ...
                            <div class="footer-social">
                                ...
                                <a href="https://www.facebook.com/Dailoii" class="facebook"><i class="fa fa-facebook"></i></a>
                                <a href="#" class="google"><i class="fa fa-google-plus"></i></a>
                                <a href="https://www.instagram.com/yeloii.95/" class="linkedin"><i class="fa fa-instagram"></i></a>
                        ...
                        <div class="footer-widget col-lg-3 col-md-6 col-sm-6 col-12 mb-40 mb-xs-35">
                            ...
                            <div class="payment-box mt-15 mb-15">
                                <a href="#"><img src="/Project_demo/uploads/images/bg/cta-bg.jpg" alt=""></a>
                            </div>
                        </div>
                        <!--Footer Widget end-->
                    </div>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-8">
                            <div class="copyright text-left">
                                <p>Copyright &copy;2024 <a href="#">Theface</a>. All rights reserved.</p>
                            </div>
                        </div>
                        <!-- <div class="col-lg-6 col-md-6 col-sm-4">
                            <div class="footer-logo text-right">
                                <a href="index.html"><img src="./view/layout/assets/imgages/Dlow2/1.jpg" alt=""></a>
                            </div>
                        </div> -->
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('.pro-qty input').change(function() {
            ...
            var price = parseFloat(row.find('.pro-price span').text().substring(1));
            var quantity = parseInt($(this).val());
            var total = price * quantity;
            row.find('.pro-subtotal span').text('$' + total.toFixed(2));
